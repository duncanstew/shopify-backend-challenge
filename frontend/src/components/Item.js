...
function Item({id, name, quantity, price, warehouse, deleteItem}) {
    ...
    return (
        <div style={{display: 'flex',flexDirection: 'row', width: '100%', backgroundColor: '#123123', justifyContent: 'space-around', backgroundColor: '#dcdcdc', margin: '5px 0px', borderRadius: '10px'}}>
            ...
            <div style={{display: 'flex', flex: 1}}>
                <p style={{color: '#111111'}}>w_id: {warehouse}</p>
            </div>
            {/* <button style={{marginRight: '3px',height: '30px', width: '30px', display: 'flex', justifyContent: 'center', alignSelf: 'center', textAlign: 'center', borderRadius: '5px', backgroundColor: '#008060', border: 'none'}} onClick={() => deleteItem(id)}>
                edit
            </button> */}
            <button style={{marginRight: '3px',height: '30px', width: '30px', display: 'flex', justifyContent: 'center', alignSelf: 'center', textAlign: 'center', borderRadius: '5px', backgroundColor: '#008060', border: 'none'}} onClick={() => deleteItem(id)}>
                del
